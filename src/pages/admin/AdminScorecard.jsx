      ...
      try {
        ...
        qList.forEach(q => {
          ...
          if (!hasAnswered) {
            ...
            if ((q.question_type === 'mcq_multiple' || q.type === 'multiple') && finalMark < posMarks) {
              ...
              return (
                <div key={q.id} className="border border-gray-300 rounded p-4 text-xs font-semibold hover:bg-gray-50 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-4 bg-gray-50 p-2.5 border border-gray-200 rounded">
                    <div>
                      <span className="text-gray-500 block text-[9px] uppercase font-bold tracking-wide">Candidate Response:</span>
                    ...
                    <div>
                      <span className="text-gray-500 block text-[9px] uppercase font-bold tracking-wide">Provisional Answer Key:</span>
