                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center gap-2 text-[11px] font-semibold font-sans">
                              ...
                              {isCorrect && isSelected && (
                                <span className="ml-auto text-[9px] font-bold bg-emerald-200 text-emerald-800 px-1.5 py-0.5 rounded font-sans">
                                  Correct & Selected
                                </span>
                              )}
                              {isCorrect && !isSelected && (
                                <span className="ml-auto text-[9px] font-medium bg-green-150 text-green-700 px-1.5 py-0.5 rounded font-sans">
                                  Correct (Not Selected)
                                </span>
                              )}
                              {!isCorrect && isSelected && (
                                <span className="ml-auto text-[9px] font-bold bg-red-200 text-red-800 px-1.5 py-0.5 rounded font-sans">
                                  Selected Wrong
                                </span>
                              )}
                            </div>
